<?php
  ...
  $nom =  htmlentities($_POST['le_nomRESPO']);
  $prenom = htmlentities($_POST['le_prenomRESPO']);
  $email =  htmlentities($_POST['l_emailRESPO']);
  $password = htmlentities($_POST['le_passRESPO']);
  $role = 1; // 0: pour l'utilisateur par défaut 1: pour le responsable
 ...
 elseif($rechercher->num_rows == 1) {
  ...
  header('Location: ajouterunrespon.php');
} else {
